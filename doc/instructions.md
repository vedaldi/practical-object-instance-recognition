...
This is an [Oxford Visual Geometry Group](http://www.robots.ox.ac.uk/~vgg) computer vision practical, authored by [Andrea Vedaldi](http://www.robots.ox.ac.uk/~vedaldi/) and Andrew Zisserman (Release 2016b).
...
* Code and data: [practical-instance-recognition-2016b.tar.gz](http://www.robots.ox.ac.uk/~vgg/share/practical-instance-recognition-2016b.tar.gz) 560MB
* Code only: [practical-instance-recognition-2016b-code-only.tar.gz](http://www.robots.ox.ac.uk/~vgg/share/practical-instance-recognition-2016b-code-only.tar.gz) 10MB
* Data only: [practical-instance-recognition-2016b-data-only.tar.gz](http://www.robots.ox.ac.uk/~vgg/share/practical-instance-recognition-2016b-data-only.tar.gz) 550MB

...
* Code and data: [practical-instance-recognition-2016a.tar.gz](http://www.robots.ox.ac.uk/~vgg/share/practical-instance-recognition-2016a.tar.gz) 560MB
* Code only: [practical-instance-recognition-2016a-code-only.tar.gz](http://www.robots.ox.ac.uk/~vgg/share/practical-instance-recognition-2016a-code-only.tar.gz) 10MB
* Data only: [practical-instance-recognition-2016a-data-only.tar.gz](http://www.robots.ox.ac.uk/~vgg/share/practical-instance-recognition-2016a-data-only.tar.gz) 550MB

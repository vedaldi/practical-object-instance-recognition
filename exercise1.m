...
figure(2) ; imagesc(im2) ; axis equal off ; hold on ;
vl_plotframe(frames2, 'linewidth', 2) ;

% Rotate the second image
im3 = imrotate(im2,35,'bilinear') ;
frames3 = getFeatures(im3, 'peakThreshold', 0.001) ;

figure(3) ; imagesc(im3) ; axis equal off ; hold on ;
...
figure(4) ; clf ; imagesc(im1) ; axis equal off ;
